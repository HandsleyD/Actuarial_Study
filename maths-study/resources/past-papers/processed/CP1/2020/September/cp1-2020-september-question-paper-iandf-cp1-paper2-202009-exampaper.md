---
normalized_id: cp1-2020-september-question-paper-iandf-cp1-paper2-202009-exampaper
exam_code: CP1
year: 2020
sitting: September
document_type: question-paper
source_repo_path: resources/past-papers/raw/CP1/CP1 Paper 2/Sep20/IandF_CP1_paper2_202009_ExamPaper.pdf
conversion_method: pdftotext
qa_status: pending
---
# cp1-2020-september-question-paper-iandf-cp1-paper2-202009-exampaper
...
CP12 S2020                                                   © Institute and Faculty of Actuaries
[Note: your work needs to link to the information provided in the questions and should
discuss/outline areas of professionalism/actuarial advice as required. Limited credit will be
given to solutions where generic answers have been given that do not refer back to the
...
1      Background
       ...
       Responsible investment is an investment strategy that integrates environmental, social
       and governance factors into investment analysis and decisions.
       ...
       (b)     a ‘Responsible Investments’ fund offered by an external investment manager,
               investing in a range of different companies.
...
2    Background
     ...
     The insurance regulator in Country X is considering how it might assess whether
     customers have been treated fairly, by surveying customers when they receive the
     payouts on their products, and then asking how happy the customers are with their
     payout.
     ...
     (iv)    Discuss the advantages and disadvantages for the following parties if the
             ...
             (a)    potential consumers in Country X.

             (b)    the overseas regulator in Country X.
                                                                                           [4]
