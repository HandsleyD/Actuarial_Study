---
normalized_id: cp1-2023-september-examiner-report-iandf-cp11-202309-examiner-report
exam_code: CP1
year: 2023
sitting: September
document_type: examiner-report
source_repo_path: resources/past-papers/raw/CP1/CP1 Paper 1/Sep23/IandF_CP11_202309_Examiner Report.pdf
conversion_method: pdftotext
qa_status: pending
---
# cp1-2023-september-examiner-report-iandf-cp11-202309-examiner-report
...
CP11 S2023                                                             © Institute and Faculty of Actuaries
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   Solutions for Subject CP1-1 - September 2023
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   The key messages may not be brought out in a way they understand                        [½]
   The consequences of the numbers in the report may not be brought out in a way the
   member can understand.                                                                  [½]
   The member may have difficulty interpreting any accounts.                               [½]
   The member may not understand the rules governing the preparation of the accounts
   and also the accounting rules and conventions that apply in the country concerned.      [½]
   The member may not understand the implications of the asset and liability valuation
   methods, and funding methods.                                                           [½]
   Each method with their own individual impacts on the reported numbers.                  [½]
   It may be necessary for the impact of these to be explained to the member.              [½]
   The report may only provide a snapshot of the scheme,                                   [½]
   whilst it will be more important to understand trends in the financial progress of the
   scheme.                                                                                 [½]
   The report may present the financial position of the scheme on different bases.         [½]
   Such as a going concern and a wind-up basis.                                            [½]
   Members may find it difficult to understand how numbers may vary on each basis          [½]
   and confusion is likely where multiple bases are included in the report.                [½]
   Actuarial valuations occur typically once every three years.                            [½]
   This could make it difficult for the member to interpret material changes in the
   schemes assets or liabilities from one valuation to the next.                           [½]
   Members may want to understand how their pension scheme is performing against
   other comparable pension schemes,                                                       [½]
   and this may be difficult due to other comparable pension schemes reporting on
   different bases.                                                                        [½]
   Members may not understand the significance of the assumptions being made               [½]
   and if sensitivities are included these may also confuse the member                     [½]
   At a very high level the member may not understand simple concepts that are
   necessary to understand the performance of the scheme.                                  [1]
   ...
   For the Value of Benefit Acted would need to consider:
   This would need to consider when the policy would likely pay out and then the
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   This would include:
   What would be covered- e.g., vet fees, ongoing medicine etc                           [1]
   Would there be any excess where policyholders would pay out before the policy
   occurred                                                                              [½]
   Would it cover existing conditions or would there be exclusions for the pet           [½]
   What pets could be covered and are they more susceptible to pay outs (e.g., age, type
   of pet)                                                                               [1]

   Other factors also need to be taken into account:
   Taxation                                                                                [½]
   Commission                                                                              [½]
   Cost of capital supporting the product                                                  [½]
   Margins for contingencies                                                               [½]
   Cost of any options and guarantees                                                      [½]
   The basis that will be used to set future provision for the liabilities, as this may be
   different from the basis used to determine the cost                                     [1]
   ...
   Finally there will need to be some market testing to assess that the product is
   actually one customers want and can afford.                                             [½]
   ...
   Is there experience of pet product pricing?                                             [½]
   Specific risks of pet insurance - e.g., claim inflation, vet prices, drug prices        [1]
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   Assets held by the pension scheme:
   Climate change will potentially affect the investments of pension schemes, both the
   assets they now hold and those they will purchase in future.                                       [½]
   Different types of asset class will be affected differently by climate change.                     [½]
   Depending on its size the pension scheme could hold a range of different types of
   asset such equities, debt (if the underlying company is affected), property and
   infrastructure investments.                                                                         [1]
   These assets may be negatively affected and will need to make changes incurring
   additional expenditure in the short term.                                                          [½]
   Climate change could impact different types of asset in different ways.                            [½]
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   Pension schemes will be affected by changes in government policy related to
   climate change.                                                                                    [½]
   More aggressive policy actions may be considered necessary if current measures
   are not considered adequate to meet the Paris Agreement targets.                                   [½]
   Any abrupt changes may lead to revaluation of asset prices which would affect the
   funds held.                                                                                        [½]
   This may increase any defined benefit pension scheme deficits.                                     [½]
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   Class selection                                                                                    [½]
   Class selection occurs by dividing lives into different groups (classes) that are

CP11 S2023                                                             © Institute and Faculty of Actuaries
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report


   expected to exhibit different levels of mortality                                                  [½]
   e.g., those who purchase/know about insurance are likely to exhibit lower mortality
   than the population as a whole                                                                     [½]
   e.g., in the case of term assurance individuals could purchase term assurance as
   they feel they are likely to have worse mortality than individuals who do not want
   to buy term assurance.                                                                             [½]
   e.g., Whole of life policyholders could be from a higher socio-economic group and
   exhibit better mortality experience than average for the general population.                       [½]
   e.g., differences by gender, occupation                                                            [½]

   Time selection                                                                                     [½]
   Mortality normally varies with calendar time                                                       [½]
   Essentially due to medical advances                                                                [½]
   ...
   Usually involves an element of self-selection, which acts to disrupt (act against) a
   controlled selection process which is being imposed on the lives                        [½]
   e.g., where an insurer’s underwriting allows a person to disclose less about their poor
   health than the insurer would ideally wish to know (“information asymmetry”)            [½]
   Hence leaving the insurer with a group with relatively higher mortality                 [½]
   or where an insurer allows less rating factors than its competitors                     [½]
   Hence attracting only a poorer mortality group of lives                                 [½]

   Spurious selection                                                                                 [½]
   Where an insurer forms groups according to a factor that does not actually drive
   mortality, but the insurer believes, wrongly/spuriously, that it does                              [1]
   e.g. when the population of England and Wales is divided by region of residence,
   Some striking mortality differences are observed                                                   [½]
   whereas these differences can be explained by the different mix of occupations and
   standards of housing and nutrition in each region                                                  [1]

   Selective decrements                                                              [½]
   Where a type of decrement has an impact on the average mortality of remaining
   policyholders                                                                     [½]
   e.g. unhealthy lives are less likely to surrender,                                [½]
   So surrenders leave the remaining portfolio with higher average mortality         [½]
   ...
   Identify aspects to consider:
   Consider the specific risks of the product - e.g. longevity risk for annuity business              [½]
   Launch of a new product it has not sold before - lack of credible data                             [½]
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   Build a model to consider the profit of new line                                       [½]
   Get credible data - e.g., industry data, data from third parties (e.g., reinsurer) etc [½]
   Utilise experts internally and externally on risks of annuitants and then how to model
   them in the profit model                                                               [1]
...
             CP1-1 - Actuarial Practice - Core Practices September 2023 - Examiners’ report
   ...
   e.g., sanctions, or change of overseas government leading to seizing of assets
   (½ marks for each relevant example up to 1 full mark)                                              [1]

   Better (or better understood) regulation in domestic market                       [½]
   ...
   Risks include design & construction, project management                                            [1]
   Could be adversely affected by regulation                                                          [½]
   But as this fund is close to the government may not matter                                         [½]
   Or events (e.g., pandemic)                                                                         [½]
