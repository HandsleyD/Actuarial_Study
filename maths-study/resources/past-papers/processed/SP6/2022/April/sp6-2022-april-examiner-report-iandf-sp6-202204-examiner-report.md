---
normalized_id: sp6-2022-april-examiner-report-iandf-sp6-202204-examiner-report
exam_code: SP6
year: 2022
sitting: April
document_type: examiner-report
source_repo_path: resources/past-papers/raw/SP6/Apr22/IandF_SP6_202204_ Examiner Report.pdf
conversion_method: pdftotext
qa_status: pending
---
# sp6-2022-april-examiner-report-iandf-sp6-202204-examiner-report
...
       SP6 - Financial Derivative Principles - Specialist Principles - April 2022 - Examiners’ report
...
Solutions for Subject SP6 - April 2022
...
           SP6 - Financial Derivative Principles - Specialist Principles - April 2022 - Examiners’ report
  ...
  If the same sequence of individual payments of a bond are discounted at a single interest
  ...
  In order to solve the stochastic differential equation in the more usual way (when s = 0 ),
  the adjusted forward price could be written as F=′ F + s and the strike price becomes
   K=′ K +s.                                                                                    [½]
  The volatility of this adjusted process is σ s , in line with the specification of the model. [½]
  Using the convention above the model becomes dF ′ = σ s F ′dBt and this is the more
  familiar stochastic differential equation with the following value for a vanilla call option. [½]
C e − rT ( F + s ) N (d1 ) − ( K + s ) N (d 2 )  ,
=                                                                                                            [½]
...
(v)
When s = 0 this becomes Black’s model and F is drawn from a lognormal distribution.                       [½]
...
As discussed in part (v), when s = 0 the model cannot accept negative rates but when
 s > 0 the lowest value which the forward rates can take is − s .                               [1]
                              s
A sufficiently large value of is required so that    F + s is a positive value for all forward
rates implied.                                                                                  [1]
This value needs to be selected before the model is run.                                       [½]
One problem with this model is determining a suitable level of volatility s .  σ               [½]
In general this is not equal σ0 + s .                                                          [½]
...
(iii)
Using the equation given in the question: δP = 45δS .                                                     [½]
The change in the return of the underlying is: δr =δS / S , so δ=
                                                                P (1350 × 3)δr and
δP= 4050δr .                                                                                              [½]
Let X be the required VaR. From the definition of VaR, Prob(δP ≤ − X ) =0.05 .                             [1]
...
From the information provided, δP  N (0, (4050 × 0.005) ) =
                                                        2
                                                           N (0, 20.252 ) .                               [1]
Using the inverse normal function, N (−33.308) =0.05 .                                                   [½]
Hence, 95% VaR = 33.308.                                                                                 [½]
...
BS pricing formulae is substituted by So𝑒𝑒 −𝑟𝑟𝑓𝑓 𝑇𝑇 .                                           [½]
...
       SP6 - Financial Derivative Principles - Specialist Principles - April 2022 - Examiners’ report
 ...
 Many candidates were able to demonstrate good knowledge of the option pricing
