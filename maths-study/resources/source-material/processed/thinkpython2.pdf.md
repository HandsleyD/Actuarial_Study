---
normalized_id: shared-pdf-reference-thinkpython2
exam_code: SHARED
material_scope: thinkpython2.pdf
material_group: shared
document_type: pdf-reference
source_repo_path: resources/source-material/shared/thinkpython2.pdf
conversion_method: pdftotext
qa_status: pending
---
# shared-pdf-reference-thinkpython2
...
repeat_lyrics()
This program contains two function definitions: print_lyrics and repeat_lyrics. Func-
...
Solution:     http: // thinkpython2. com/ code/ flower. py ,              also requires http:
...
If you write encounter an infinite recursion by accident, review your function to confirm
...
The raise statement can take a detailed error message as an optional argument. For exam-
ple:
...
Format the output: Formatting debugging output can make it easier to spot an error. We
    saw an example in Section 6.9. The pprint module provides a pprint function that
    displays built-in types in a more human-readable format (pprint stands for “pretty
    print”).
...
tributes of a new class called Markov. Solution: http://thinkpython2.com/code/Markov.
...
Another problem that can occur with big expressions is that the order of evaluation may
                                                                            x
not be what you expect. For example, if you are translating the expression 2π into Python,
you might write:
y = x / 2 * math.pi
...
addition with carrying, 68             Austin, Jane, 127
...
comment, 13, 15                                  185, 193
commutativity, 13, 167                      by bisection, 68
...
deterministic, 126, 134                               element, 89, 99
...
dictionary, 103, 112, 120, 197                        epsilon, 67
      ...
      reverse lookup, 106                                   runtime, 14, 44, 46, 193
      subtraction, 129                                      semantic, 14, 193, 198
      traversal, 120, 168                                   shape, 122
dictionary methods, 204                                     syntax, 13, 193
      dbm module, 141                                 error checking, 58
dictionary subtraction, 186                           error message, 7, 13, 14, 193
diff, 146                                             eval function, 69
Dijkstra, Edsger, 87                                  evaluate, 10
dir function, 197                                     exception, 14, 15, 193, 196
directory, 139, 145                                         AttributeError, 152, 197
214                                                                                   Index

     IndexError, 72, 78, 90, 197                   formal language, 4, 7
     IOError, 140                                  format operator, 138, 145, 197
     KeyError, 104, 197                            format sequence, 138, 145
     LookupError, 107                              format string, 138, 145
     NameError, 22, 197                            frame, 23, 26, 44, 56, 109
     OverflowError, 46                             Free Documentation License, GNU, v, vi
     RuntimeError, 45                              frequency, 105
     StopIteration, 185                                 letter, 123
     SyntaxError, 19                                    word, 125, 134
     TypeError, 72, 74, 108, 116, 118, 139, 164,   fruitful function, 24, 26
          197                                      frustration, 200
     UnboundLocalError, 110                        function, 3, 17, 19, 25, 161
     ValueError, 46, 117                                abs, 52
exception, catching, 140                                ack, 61, 113
execute, 11, 14                                         arc, 31
exists function, 139                                    choice, 126
experimental debugging, 25, 134                         circle, 31
exponent, 202                                           compare, 52
exponential growth, 203                                 deepcopy, 152
expression, 10, 14                                      dict, 103
     big and hairy, 199                                 dir, 197
     boolean, 40, 47                                    enumerate, 119
     conditional, 183, 191                              eval, 69
     generator, 185, 186, 191                           exists, 139
extend method, 92                                       factorial, 56, 183
                                                        fibonacci, 57, 109
factorial, 183                                          find, 74
factorial function, 56, 58                              float, 17
factory, 191                                            getattr, 168
factory function, 188, 189                              getcwd, 139
False special value, 40                                 hasattr, 153, 168
Fermat’s Last Theorem, 48                               input, 45
fibonacci function, 57, 109                             int, 17
file, 137                                               isinstance, 58, 153, 166
      permission, 140                                   len, 26, 72, 104
      reading and writing, 137                          list, 94
file object, 83, 87                                     log, 18
filename, 139                                           max, 117, 118
filter pattern, 93, 100, 184                            min, 117, 118
find function, 74                                       open, 83, 84, 137, 140, 141
flag, 110, 112                                          polygon, 31
float function, 17                                      popen, 142
float type, 4                                           programmer defined, 22, 129
floating-point, 4, 7, 67, 183                           randint, 101, 126
floating-point division, 39                             random, 126
floor division, 39, 46, 47                              recursive, 43
flow of execution, 21, 26, 58, 59, 65, 178, 196         reload, 144, 195
flower, 37                                              repr, 144
folder, 139                                             reversed, 121
for loop, 30, 44, 72, 91, 119, 184                      shuffle, 175
Index                                                                               215

    sorted, 99, 106, 121                 HashMap, 207
    sqrt, 18, 53                         hashtable, 112, 206, 210
    str, 18                              header, 19, 25, 194
    sum, 118, 185                        Hello, World, 3
    tuple, 115                           hexadecimal, 148
    type, 153                            high-level language, 6
    zip, 118                             histogram, 105
function argument, 21                         random choice, 126, 130
function call, 17, 26                         word frequencies, 127
function composition, 54                 Holmes, Sherlock, 25
function definition, 19, 20, 25          homophone, 113
function frame, 23, 26, 44, 56, 109      hypotenuse, 54
function object, 27
function parameter, 21                   identical, 100
function syntax, 162                     identity, 96, 152
function type, 20                        if statement, 41
    modifier, 157                        immutability, 74, 79, 97, 108, 115, 121
    pure, 156                            implementation, 105, 112, 132, 169
function, fruitful, 24                   import statement, 26, 144
function, math, 18                       in operator, 205
function, reasons for, 24                in operator, 76, 85, 90, 104
function, trigonometric, 18              increment, 64, 69, 157, 163
function, tuple as return value, 117     incremental development, 60, 193
function, void, 24                       indentation, 19, 162, 194
...
get method, 105                          information hiding, 169
getattr function, 168                    inheritance, 176, 178, 180, 190
getcwd function, 139                     init method, 164, 168, 172, 174, 176
global statement, 110, 112               initialization
global variable, 110, 112                      variable, 69
     update, 110                         initialization (before update), 64
GNU Free Documentation License, v, vi    input function, 45
greatest common divisor (GCD), 61        instance, 148, 153
grid, 27                                       as argument, 149
guardian pattern, 59, 60, 78                   as return value, 150
                                         instance attribute, 148, 153, 172, 180
Hand class, 176                          instantiate, 153
hanging, 195                             instantiation, 148
HAS-A relationship, 177, 180             int function, 17
hasattr function, 153, 168               int type, 4
hash function, 108, 112, 207             integer, 4, 7
hashable, 108, 112, 120                  interactive mode, 11, 14, 24
216                                                                      Index

interface, 33, 36, 169, 179         lipogram, 84
interlocking words, 101             Liskov substitution principle, 179
interpret, 6                        list, 89, 94, 99, 121, 184
interpreter, 2                            as argument, 97
invariant, 159, 160                       concatenation, 91, 97, 101
invert dictionary, 107                    copy, 92
invocation, 76, 79                        element, 90
IOError, 140                              empty, 89
...
iterator, 119–121, 123, 204               slice, 91
                                          traversal, 91
join, 204                           list comprehension, 184, 191
join method, 95, 175                list methods, 204
Kangaroo class, 170                 literalness, 5
key, 103, 112                       local variable, 22, 26
key-value pair, 103, 112, 120       log function, 18
keyboard input, 45                  logarithm, 135
KeyError, 104, 197                  logarithmic growth, 203
KeyError, 206                       logical operator, 40
keyword, 10, 14, 194                lookup, 112
     def, 19                        lookup, dictionary, 106
     elif, 42                       LookupError, 107
     else, 41                       loop, 31, 36, 65, 119
keyword argument, 33, 36, 191             condition, 196
Koch curve, 49                            for, 30, 44, 72, 91
                                          infinite, 65, 196
language                                  nested, 174
     formal, 4                            traversal, 72
     natural, 4                           while, 64
     safe, 14                       loop variable, 184
...
linear search, 205                  maintainable, 169
LinearMap, 206                      map pattern, 93, 100
Linux, 25                           map to, 171
Index                                                                          217

mapping, 112, 131                  method syntax, 162
Markov analysis, 130               method, list, 92
mash-up, 132                       Meyers, Chris, vi
math function, 18                  min function, 117, 118
matplotlib, 135                    Moby Project, 83
max function, 117, 118             model, mental, 199
McCloskey, Robert, 73              modifier, 157, 160
md5, 143                           module, 18, 26
MD5 algorithm, 146                     bisect, 101
md5sum, 146                            collections, 187, 188, 190
membership                             copy, 151
    binary search, 101                 datetime, 160
    bisection search, 101              dbm, 141
    dictionary, 104                    os, 139
    list, 90                           pickle, 137, 142
    set, 113                           pprint, 112
memo, 109, 112                         profile, 133
mental model, 199                      random, 101, 126, 175
metaphor, method invocation, 163       reload, 144, 195
metathesis, 123                        shelve, 142
method, 36, 75, 161, 169               string, 125
    __cmp__, 173                       structshape, 122
    __str__, 165, 174                  time, 101
    add, 165                       module object, 18, 143
    append, 92, 97, 174, 175       module, writing, 143
    close, 138, 141, 143           modulus operator, 39, 47
    count, 79                      Monty Python and the Holy Grail, 156
    extend, 92                     MP3, 146
    get, 105                       mro method, 179
    init, 164, 172, 174, 176       multiline string, 35, 194
    items, 120                     multiplicity (in class diagram), 178, 181
    join, 95, 175                  multiset, 187
    mro, 179                       mutability, 74, 90, 92, 96, 111, 115, 121, 151
    pop, 94, 175                   mutable object, as default value, 170
    radd, 167
...
method append, 101
method resolution order, 179       Obama, Barack, 201
218                                                                                     Index

object, 74, 79, 95, 96, 100                    or operator, 40
    bytes, 141, 145                            order of growth, 202, 209
    class, 147, 148, 153, 190                  order of operations, 12, 14, 199
...
Ramanujan, Srinivasa, 70                  runtime error, 14, 44, 46, 193, 196
randint function, 101, 126                RuntimeError, 45, 58
random function, 126
random module, 101, 126, 175              safe language, 14
...
semantic error, 14, 15, 193, 198             conditional, 41, 47, 55, 184
semantics, 15, 162                           for, 30, 72, 91
...
sum, 185                                            turtle typewriter, 37
sum function, 118                                   TurtleWorld, 48
superstitious debugging, 200                        type, 4, 7
swap pattern, 116                                        bool, 40
syntax, 5, 7, 13, 162, 194                               dict, 103
syntax error, 13, 15, 193                                file, 137
